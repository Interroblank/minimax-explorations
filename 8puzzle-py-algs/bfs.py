...
import heapq as hq  # TODO - This is a priority queue!
                    # It should be a regular queue.
                    # Though for BFS, the difference should be negligible.
...
def bfs(init_state, goal_state):
    ...
    while queue: # While the queue is not empty:
        ...
        curr = hq.heappop(queue) # Pop the next node in the queue.
        ...
        for neighbor in children[tuple(curr)]: # For each neighbor of 'curr':
            ...
            if tuple(neighbor) not in expanded.keys():
                ...
                # Mapping necessary data and pushing state to queue.
